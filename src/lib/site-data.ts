...
export const projects: Project[] = [
  ...
  },
  {
    ...
    code: "gmaps-scraper",
    type: "Lead Capture Chrome Extension",
    status: "In Development",
    title: "Google Maps Scraping Extension",
    summary:
      "A Chrome extension that turns Google Maps results into clean, export-ready lead lists in under a minute for outreach, research, and sales ops teams.",
    stack: ["TypeScript", "Chrome Extension APIs", "React", "Node.js"],
    previewImage: "/scrappy.png",
    videoEmbedUrl: "https://youtu.be/30usLf31qSc?si=H4XaW_OnkAMarLN7",
    overview:
      "Built for teams that depend on lead data but cannot afford the drag of manual copy-paste, this extension converts public Google Maps listings into structured spreadsheets directly inside the browser. Instead of opening every card, collecting names, contact details, and listing information one by one, users can select a sample result, define a limit, and let the extension capture matching listings automatically. The result is a faster path from search to usable business data for prospecting, market mapping, competitor monitoring, and operations research.",
    built: [
      "Card-based extraction flow that identifies similar Google Maps listings from a single selection",
      "Fast bulk capture of business names, contact details, and listing fields into structured rows",
      "Side-panel workflow built for non-technical teams working directly inside the browser",
      "Export-ready output for spreadsheets, CRMs, reports, outreach campaigns, and internal dashboards",
      "Designed around repeatable business use cases like lead generation, competitor scans, and directory research",
    ],
    outcomes: [["Manual work", "Minutes instead of hours"], ["Output", "Clean spreadsheet-ready data"], ["Fit", "Works inside existing sales workflows"]],
  },
  {
    slug: "gk-realty",
    year: "2024",
